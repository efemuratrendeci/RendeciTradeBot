    ...
    static addNewVal = (val) => {
        ...
        if (length > 1) {
            ...
            if (CoinObservation.current_observation[length - 1] > CoinObservation.current_observation[length - 2] /**Hali hazırda ölçüm yönü yukarı ise */
                ...
                if (CoinObservation.current_observation[length - 1] < val * 1.0045 /**Yeni gelen veri eski veriden 25/10000 oranında aşağıda ise hiçbirşey değişmemiş demektir. Gözleme dahil edilmemeli */) return false;
